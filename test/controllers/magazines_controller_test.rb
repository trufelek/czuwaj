...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { description: @magazine.description, name: @magazine.name, picture: @magazine.picture, price: @magazine.price, user_id: @magazine.user_id }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { description: @magazine.description, name: @magazine.name, picture: @magazine.picture, price: @magazine.price, user_id: @magazine.user_id }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
